...
short_description = "A textual user interface (TUI) for MDAnalysis".strip().split("\n")[0]
...
setup(
    ...
    name='mda_tui',
    author='Paul Smith',
    author_email='paul.j.smith@ucl.ac.uk',
    ...
    # url='mda-tui.readthedocs.io/en/latest/',  # Website
    # platforms=['Linux',
    #            'Mac OS-X',
    #            'Unix',
