...
class Translate(Vertical):
    ...
    id = str(translate).removeprefix("<class '").removesuffix("'>").replace(".", "_")
...
class CenterInBox(Vertical):
    ...
    id = str(center_in_box).removeprefix("<class '").removesuffix("'>").replace(".", "_")
...
class Wrap(Vertical):
    ...
    transformation = wrap
    id = str(wrap).removeprefix("<class '").removesuffix("'>").replace(".", "_")
...
class Unwrap(Vertical):
    ...
    id = str(unwrap).removeprefix("<class '").removesuffix("'>").replace(".", "_")
...
class NoJump(Vertical):
    ...
    id = str(nojump).removeprefix("<class '").removesuffix("'>").replace(".", "_")
