...
The MDAnalysis TUI *Code of Conduct* sets the rules for the behavior of
every member in the MDAnalysis TUI community so that everyone can
...
MDAnalysis TUI is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make MDAnalysis TUI a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and MDAnalysis TUI is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of MDAnalysis TUI comes from its varied community
...
reported by contacting the project team at 'paul.j.smith@ucl.ac.uk'. The project team will
